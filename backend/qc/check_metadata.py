...
from .shim.ebooks.metadata import authors_to_string, check_isbn, title_sort
from .shim import info_dialog, error_dialog
from .shim.utils.localization import get_udc
from .shim.utils.titlecase import titlecase

from . import menus as cfg
from .check_base import BaseCheck
from .dialogs import ResultsSummaryDialog
from .helpers import get_formatted_author_initials
...
class MetadataCheck(BaseCheck):
    ...
    def check_series_pubdate(self):
        ...
        from .shim.utils.date import utc_tz
