...
from .shim.polyglot_builtins import unicode_type, is_py3
from .shim.sixshim import text_type as unicode
from .shim.sixshim.moves.urllib.parse import unquote as urlunquote
import traceback, os, posixpath, re
from .shim import sixshim as six
try:
...
from .shim import guess_type
from .shim import error_dialog
from .shim.ebooks.chardet import xml_to_unicode
from .shim.ebooks.conversion.preprocess import HTMLPreProcessor
from .shim.ebooks.metadata.epub import Encryption
from .shim.ebooks.oeb.base import XPath
from .shim.ebooks.oeb.parse_utils import NotHTML, parse_html
from .shim.utils.zipfile import ZipFile, BadZipfile

from .check_base import BaseCheck
from .dialogs import SearchEpubDialog
...
class EpubCheck(BaseCheck):
    ...
    def check_epub_css_margins(self):
        ...
        def get_user_margins():
            ...
            from .shim.ebooks.conversion.config import load_defaults
    ...
    def _parse_xhtml(self, data, name):
        ...
        from .shim.utils.logging import Log
        log = Log()
        try:
